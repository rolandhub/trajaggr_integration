...
\begin{small}
<<load_TestData, eval=FALSE, echo=TRUE>>=
...
\begin{small}
<<exampledata_vulture_movestack_inspect1, eval=TRUE, echo=TRUE>>=
library(trajaggr)
...
\begin{small}
<<exampledata_pigeon_movestack_inspect, eval=TRUE, echo=TRUE>>=
# library(trajaggr)
...
\begin{small}
<<exampledata_wildboars_ltraj_inspect, eval=TRUE, echo=TRUE>>=
# library(trajaggr)
...
\begin{small}
<<coercion_move_part_1, eval=TRUE, echo=TRUE>>=
...
\begin{small}
<<coercion_tomove_part_1, eval=TRUE, echo=TRUE>>=
...
\begin{small}
<<coercion_ltraj_part_1, eval=TRUE, echo=TRUE>>=
# library(trajaggr)
...
\begin{small}
<<coercion_ltraj_part_2, eval=FALSE, echo=TRUE>>=
...
\begin{small}
<<coercion_ltraj_part_3, eval=TRUE, echo=FALSE>>=
...
\begin{small}
<<coercion_toLtraj_part_1, eval=TRUE, echo=TRUE>>=
...
\begin{small}
<<over_overview, eval=TRUE, echo=TRUE>>=
library(trajectories)
library(trajaggr)
...
% Load data - temporally solution... ??? !!! (How to load data for vignette???)
\begin{small}
<<load_TestData, eval=TRUE, echo=TRUE>>=
load(system.file("extdata","trajaggr_TestData.RData", 
...
\begin{small}
<<inspect_TestData_1, eval=TRUE, echo=TRUE>>=
class(Track_A1)[1]
...
\begin{figure}[!htb]
\centering
<<over_stf_inspect_byFig, eval=TRUE, echo=FALSE, fig=TRUE>>=
TA1 <- Track_A1 # sic
TA1@data$Point_Nr <- as.factor(seq(1:length(TA1)))

#pie(rep(1,6), col=gray((8:0/8)[2:7]))
...
\begin{small}
<<over_stf_inspect_over1, eval=TRUE, echo=TRUE>>=
...
\begin{small}
<<over_stf_inspect_over2, eval=TRUE, echo=TRUE>>=
...
\begin{small}
<<over_stf_inspect_over3, eval=TRUE, echo=TRUE>>=
...
\begin{small}
<<over_stf_inspect_4, eval=TRUE, echo=TRUE>>=
over(x = stf_Polys_4t, y= Track_A1, returnList = FALSE,
...
\begin{small}
<<over_stf_inspect_5, eval=TRUE, echo=TRUE>>=
...
\begin{small}
<<over_stf_inspect_weightmean_ex, eval=TRUE, echo=TRUE>>=
...
\begin{small}
<<over_sp_inspect_over1, eval=TRUE, echo=TRUE>>=
...
\begin{small}
<<over_sp_inspect_over2, eval=TRUE, echo=TRUE>>=
...
\begin{small}
<<over_sp_inspect_over3, eval=TRUE, echo=TRUE>>=
...
\begin{small}
<<over_sp_inspect_over2xts, eval=TRUE, echo=TRUE>>=
...
\begin{small}
<<over_sp_noTime_1, eval=TRUE, echo=TRUE>>=
...
\begin{small}
<<over_sp_noTime_2, eval=TRUE, echo=TRUE>>=
...
\begin{small}
<<count_vulture_movestack_cverview, eval=TRUE, echo=TRUE>>=
...
\begin{small}
<<count_vulture_movestack_prep_0.0, eval=TRUE, echo=FALSE>>=
data(vulture_moveStack)
...
\begin{small}
<<count_vulture_movestack_prep_1, eval=TRUE, echo=FALSE>>=
...
\begin{small}
<<count_sp_vulture_TracksX1_count_1, eval=TRUE, echo=TRUE>>=
...
\begin{figure}[!htb]
\centering
<<count_sp_vulture_TracksX1_fig_1, eval=TRUE, echo=FALSE, fig=TRUE>>=
...
\begin{small}
<<count_sp_vulture_TrCbyID_count_1, eval=TRUE, echo=TRUE>>=
...
\begin{figure}[!htb]
\centering
<<count_sp_vulture_TrC_fig_1, eval=TRUE, echo=FALSE, fig=TRUE>>=
...
\begin{small}
<<count_stf_vulture_TracksX_count_1, eval=TRUE, echo=TRUE>>=
...
\begin{figure}[!htb]
\centering
<<count_stf_vulture_X3_fig_1, eval=TRUE, echo=FALSE, fig=TRUE>>=
...
\begin{small}
<<agg_overview, eval=TRUE, echo=TRUE>>=
...
\begin{small}
<<agg_stf_vulture_TracksX1_agg_1, eval=TRUE, echo=TRUE>>=
...
\begin{figure}[!htb]
\centering
<<agg_stf_vulture_Tracks_X1_fig_1, eval=TRUE, echo=FALSE, fig=TRUE>>=
...
\begin{small}
<<agg_stf_vulture_TrC_agg_2, eval=TRUE, echo=TRUE>>=
...
\begin{figure}[!htb]
\centering
<<agg_stf_vulture_TrC_fig_2, eval=TRUE, echo=FALSE, fig=TRUE>>=
...
\begin{small}
<<agg_sp_pigeon_preparation_1, eval=TRUE, echo=TRUE>>=
...
\begin{small}
<<agg_sp_pigeon_TrColl_1, eval=TRUE, echo=TRUE>>=
...
\begin{figure}[!htb]
\centering
<<agg_sp_pigeon_TrColl_fig_1, eval=TRUE, echo=FALSE, fig=TRUE>>=
# obj <- agg_vTrC_wMeanSpd
# #par_sic <- par()
# #mfcol=c(nrows, ncols) 
# #par("mfcol")
...
\begin{small}
<<agg_stf_pureSpatial_prep_1, eval=TRUE, echo=TRUE>>=
# Load data
...
\begin{figure}[!htb]
\centering
<<agg_stf_pureSpatial_fig_1, eval=TRUE, echo=FALSE, fig=TRUE>>=
#mx <- max(count_Tracks_X1@data$ntraj, na.rm = TRUE)
mx = 6
mycol <- gray(((mx + 2):0/(mx + 2))[2:(mx+1)])
...
\begin{small}
<<appendix_vulture_movestack_prep_1, eval=TRUE, echo=TRUE>>=
# library(trajaggr)
data(vulture_moveStack)
class(vulture_moveStack)[1]
vulture_TrC <- as(vulture_moveStack, "TracksCollection")
...
\begin{small}
<<appendix_vulture_movestack_prep_2, eval=TRUE, echo=TRUE>>=
# Create a list of adequate MoveStack objects
# library(move)
vulture_moveObjList <- move::split(vulture_moveStack)
vulture_moveStackList <- lapply(vulture_moveObjList, function(x) {
...
\begin{small}
<<valid_coercion_move_part_1, eval=TRUE, echo=TRUE>>=
### Coercion of MoveStack to Tracks
# library(trajaggr)
data(vulture_moveStack)
class(vulture_moveStack)[1]
...
\begin{small}
<<valid_coercion_tomove_part_1, eval=TRUE, echo=TRUE>>=
### Coercion of Tracks to MoveStack
# library(trajaggr)
class(v_Tracks)[1]
# library(move)
...
\begin{small}
<<valid_coercion_ltraj_part_1, eval=TRUE, echo=TRUE>>=
# library(trajaggr)
data(wildboars_4Ind_ltraj)
class(wildboars_4Ind_ltraj[1])
...
\begin{small}
<<valid_coercion_toLtraj_part_1, eval=TRUE, echo=TRUE>>=
# Coercion of Track to ltraj
# library(trajaggr)
wb_1_ltraj <- as(wb_1_Track, "ltraj")
class(wb_1_ltraj)
